            ...
            <div className="space-y-2">
              ...
              <div className="pt-3">
                <label className="inline-flex items-center relative">
                  ...
                  <span className="ml-2 text-sm font-medium text-gray-500">
                    <span className="cursor-pointer underline mr-1">개인정보 수집 및 이용동의</span>
                    <span className="text-orange-600">(필수)</span>
                  </span>
                </label>
              </div>
              <div className="mt-2 border border-gray-300 rounded-md h-16 overflow-y-auto p-2 text-sm">
                <h4 className="text-gray-900 font-semibold">개인정보 수집 및 이용동의</h4>
              ...
              <div className="pt-3">
                <label className="inline-flex items-center relative">
                  ...
                  <span className="ml-2 text-sm font-medium text-gray-500">
                    <span className="cursor-pointer underline mr-1">이용약관 동의</span>
                    <span className="text-orange-600">(필수)</span>
                  </span>
                </label>
              </div>
              ...
              <div className="mt-2 border border-gray-300 rounded-md h-16 overflow-y-auto p-2 text-sm">
                <h4 className="text-gray-900 font-semibold">이용약관</h4>
                <p className="text-gray-700">
                  gggggggg
                  gggggggg
                  gggggggggggggggg
